...
<body>
    ...
    <div class="bg-[#EEF5FF] w-100 h-[100vh] flex justify-center items-center ">
        <form action="Database.php" class="w-full max-w-lg">
            ...
            <input class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" type="submit" value="login">
